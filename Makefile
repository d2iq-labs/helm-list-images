...
BUILD_WITH_FLAGS="-s -w -X 'github.com/d2iq-labs/helm-list-images/version.Version=${VERSION}' -X 'github.com/d2iq-labs/helm-list-images/version.Env=${BUILD_ENVIRONMENT}' -X 'github.com/d2iq-labs/helm-list-images/version.BuildDate=${DATE}' -X 'github.com/d2iq-labs/helm-list-images/version.Revision=${REVISION}' -X 'github.com/d2iq-labs/helm-list-images/version.Platform=${PlATFORM}/${ARCHITECTURE}' -X 'github.com/d2iq-labs/helm-list-images/version.GoVersion=${GOVERSION}'"
...
generate.document: ## generates cli documents using 'github.com/spf13/cobra/doc'.
	@go generate github.com/d2iq-labs/helm-list-images/docs
